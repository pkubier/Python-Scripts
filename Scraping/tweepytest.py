...
def scraptweets(search_words, date_since, numTweets, numRuns):
    ...
    path = os.getcwd()
    filename = to_csv_timestamp + 'UCO-Twitter-Mentions.csv'
...
search_words = "UCO OR Bronchos OR UniversityofCentralOklahoma OR Neuhold-Ravikumar OR Nigh OR Betz OR Murdgaugh OR WestHall OR TheQuad"
date_since = "2000-01-03"
numTweets = 2500
numRuns = 45
